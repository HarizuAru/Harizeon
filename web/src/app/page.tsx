...
const SERVICES = [
  ...
  },
  {
    ...
    description: "Continuous attack surface management. Automated subdomain discovery and DNS zone drift alerts.",
    status: "available",
    href: "/services",
  },
  {
  ...
  },
  {
    ...
    description: "Cryptographic protocol posture, TLS certificate expiry tracking, and HTTP security headers.",
    status: "available",
    href: "/services",
  },
  {
    code: "VLT",
    name: "Harizeon Vault",
    description: "Public credential leak detection and exposed secret repository reconnaissance.",
    status: "beta",
    href: "/services",
  },
  {
    code: "ADT",
    name: "Harizeon Audit",
    description: "Executive compliance reports (ISO 27001, SOC 2, Malaysian CCA) and verifiable audit trails.",
    status: "available",
    href: "/services",
  },
  {
    code: "WCH",
    name: "Harizeon Watch",
    description: "Continuous real-time threat intelligence and anomalous DNS record modifications.",
    status: "coming soon",
    href: "/services",
  },
  {
    ...
    description: "Automated virtual patching guidance and WAF rule generation from confirmed findings.",
    status: "coming soon",
    href: "/services",
  },
  {
    code: "GRD",
    name: "Harizeon Guard",
    description: "CI/CD pull-request security gates and automated deployment policy compliance.",
    status: "coming soon",
    href: "/services",
  },
];
